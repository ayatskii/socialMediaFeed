...
func (h *Handler) RegisterRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /api/posts/feed", h.GetFeed)
	mux.HandleFunc("GET /api/posts/trending", h.GetTrending)
	mux.HandleFunc("GET /api/posts/author/{authorId}", h.GetPostsByAuthor)
	mux.HandleFunc("GET /api/posts/hashtag/{tag}", h.GetPostsByHashtag)
